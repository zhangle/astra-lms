...
class CoursesControllerTest < Test::Unit::TestCase
  ...
  def test_show
    ...
    assert_equal false, assigns(:course).valid?
  end
  ...
  def test_create
    ...
    post :create, :course => {:full_name => "Introduction to Object-Oriented Programming", :short_name => "CS 101"}
  ...
  def test_update
    post :update, :id => @first_id,
                  :course => {:description => "Something really nice",
                              :started_at => Time.now,
